...
Public Class FormProject
    ...
    Private Sub BtnDelProject_Click(sender As Object, e As EventArgs) Handles BtnDelProject.Click
        If BtnDelProject.Text.ToLower = "non active" Then
    ...
    End Sub
    Sub LoadReport()
        Me.ReportProjectTableAdapter.Fill(Me.DataSetReport.ReportProject)
        Dim Report As New ReportProject With {.DataSource = DataSetReport.Tables("ReportProject"), .DataMember = "ReportProject"}
    ...
    Private Sub CheckEdit1_CheckedChanged(sender As Object, e As EventArgs) Handles CheckEdit1.CheckedChanged
        If CheckEdit1.CheckState = CheckState.Checked Then
            LoadData2()
            BtnDelProject.Text = "Restore"
        Else
            LoadData()
            BtnDelProject.Text = "Non Active"
        End If
    End Sub
End Class