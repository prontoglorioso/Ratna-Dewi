...
Public Class FormCustomer
    ...
    Private Sub BtnDelCustomer_Click(sender As Object, e As EventArgs) Handles BtnDelCustomer.Click
        If BtnDelCustomer.Text.ToLower = "non active" Then
    ...
    End Sub
    Sub LoadReport()
        Me.ReportCustomerTableAdapter.Fill(Me.DataSetReport.ReportCustomer)
        Dim Report As New ReportCustomer With {.DataSource = DataSetReport.Tables("ReportCustomer"), .DataMember = "ReportCustomer"}
    ...
    Private Sub CheckEdit1_CheckStateChanged(sender As Object, e As EventArgs) Handles CheckEdit1.CheckStateChanged
        If CheckEdit1.CheckState = CheckState.Checked Then
            LoadData2()
            BtnDelCustomer.Text = "Restore"
        Else
            LoadData()
            BtnDelCustomer.Text = "Non Active"
