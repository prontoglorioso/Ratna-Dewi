...
Class FormVendor
    ...
    Private Sub BtnDelVendor_Click(sender As Object, e As EventArgs) Handles BtnDelVendor.Click
        If BtnDelVendor.Text.ToLower = "non active" Then
    ...
    Sub LoadReport()
        Me.ReportVendorTableAdapter.Fill(Me.DataSetReport.ReportVendor)

        Dim Report As New ReportVendor With {.DataSource = DataSetReport.Tables("ReportVendor"), .DataMember = "ReportVendor"}
    ...
    Private Sub CheckEdit1_CheckStateChanged(sender As Object, e As EventArgs) Handles CheckEdit1.CheckStateChanged
        If CheckEdit1.CheckState = CheckState.Checked Then
            LoadData2()
            BtnDelVendor.Text = "Restore"
        Else
            LoadData()
            BtnDelVendor.Text = "Non Active"
